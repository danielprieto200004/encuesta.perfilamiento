...
# from dotenv import load_dotenv # Comentado para producción en Azure

# load_dotenv() # Comentado para producción en Azure
...
if __name__ == '__main__':
    # El puerto se define por la variable de entorno PORT en Azure App Service
